				...
				<table border="2" class="table">
					...
					<%
						try {
							...
							String query = "Select complaintid,category,issue,Description,cmethod,RequestedBy,Status,Comments from complaint where requestedby= '"
									+ us + "' and status='Open'";
					...
					<tr>
						<form method="post" action="command" ?name=action>
							...
							<td><input type="submit" name="action" value="close">
							</td>
						</form>
					</tr>
					<%
