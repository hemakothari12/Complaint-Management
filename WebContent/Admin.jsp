	...
	<div class="row content">
		<div class="col-sm-3 sidenav hidden-xs">
			<ul class="nav nav-pills nav-stacked">
				<li class="active"><a href="AddNew.jsp?value=Technology">Add Complaint</a></li>
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="well">
						...
						<p>Request support for workstation, mobile, access and boarding.</p>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="well">
						...
						<p>Submit request for benefits, leave, pay, time and personal details.</p>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="well">
						...
						<p>Create a request for your desk, floor, room and building needs.</p>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="well">
